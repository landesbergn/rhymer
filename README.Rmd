...
Each function takes the basic arguments of:  
  ...
  - `return_type` what type of data return (options are _df_ for a dataframe, _vector_ for a vector, _word_ for a single word, and _random\_word_ for a random word)  
